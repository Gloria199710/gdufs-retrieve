...
package com.gdufs.utils;

import com.gdufs.entity.ColumnEntity;
import com.gdufs.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "com.gdufs" : mainPath;
